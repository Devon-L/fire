...
var Hx = {
    ...
    showLottery: function (iCan) {
        ...
        if (big_arr.length > 0) {
            ...
            var djimg = (Milo && Milo.aParams && Milo.aParams.urlimg ? Milo.aParams.urlimg : 'https://game.gtimg.cn/images/actdaoju/act/a20250708gift/') + 'lot/lot' + big_arr[0]["imgNum"] + '.png';
            ...
            var ewm_img = (Milo && Milo.aParams && Milo.aParams.urlimg ? Milo.aParams.urlimg : 'https://game.gtimg.cn/images/actdaoju/act/a20250708gift/') + "lot/ewm.png";
            var label_img = (Milo && Milo.aParams && Milo.aParams.urlimg ? Milo.aParams.urlimg : 'https://game.gtimg.cn/images/actdaoju/act/a20250708gift/') + "lot/label" + label_num + ".png";
            var textParts = [{
                text: "�ۼƳ�ȡ",
                color: "#251e1e",
                line: 0,
            ...
            var lot_img_txt = (Milo && Milo.aParams && Milo.aParams.urlimg ? Milo.aParams.urlimg : 'https://game.gtimg.cn/images/actdaoju/act/a20250708gift/') + 'lot/lot' + big_arr[0]["imgNum"] + '.png?t=' + Date.now(); // 备用绝对路径
            if (location.hostname == "act.daoju.qq.com") {
        ...
        if (Hx.show_dj.dj_arr.length > 0) {
            ...
            if (dj_arr.length == 1) {
                ...
                $.each(dj_arr, function (k, v) {
                    var src = (Milo && Milo.aParams && Milo.aParams.urlimg ? Milo.aParams.urlimg : 'https://game.gtimg.cn/images/actdaoju/act/a20250708gift/') + 'lot/lot' + v["imgNum"] + '.png';
                    var _html = '<li>' +
                                            '<img src="' + src + '" alt="">' +
                                    '</li>';
                ...
                // 图片加载错误回退：显示文字名称
                $("#lottery1 .lot1 img").off('error').on('error', function(){
                ...
                // 图片加载错误回退：显示文字名称
                $("#lottery10 .lot10 img").off('error').on('error', function(){
                    var $li = $(this).closest('li');
                    var idx = $li.index();
                    var item = dj_arr[idx] || {};
                    $(this).remove();
